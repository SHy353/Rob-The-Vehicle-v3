class CLobbyboardB extends CContext
{
	Background = null;
	Background1 = null;
	...
	//	this.Background.Pos = VectorScreen( 200, 300 );
		...
		this.Background.Pos3D = Vector( -984.767,-258.128,381.3 );
		this.Background.Size3D = Vector( 8, 6, 0 );
		this.Background.Rotation3D = Vector( 11, 0, 1.69 );
	...
	//	local score2 = GUILabel();
		...
		name.TextColour = Colour( 51, 102, 255 );
		name.FontSize = 30;
	...
	/*	this.Background.AddChild( score2 );
		...
		score2.Pos = VectorScreen( 1015, ( 80 + ( 40 * this.Top5Killers.len() ) ) );*/
